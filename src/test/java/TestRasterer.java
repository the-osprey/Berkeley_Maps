...
public class TestRasterer {
    ...
    @Test
    public void myDepthCheck() {
        assertEquals(2.0, Rasterer.getDLevel(-122.2104604264636, -122.30410170759153, 1085.0), .05);
        assertEquals(7.0, Rasterer.getDLevel(-122.24053, -122.241632, 892.0), .05);
    }

    @Test
    public void myTileAcrossCheck() {
        assertEquals(31.0, Rasterer.numTilesAcross(5), .05);
        assertEquals(127.0, Rasterer.numTilesAcross(7), .05);
        assertEquals(0.0, Rasterer.numTilesAcross(0), .05);
    }

    @Test
    public void testGetULQuerImg() {
//        assertEquals(84.0, Rasterer.getImgULLon(-122.241632, 7), 0.05);
//        assertEquals(28.0, Rasterer.getImgULLat(37.87655, 7), 0.05);
//        assertEquals(86.0, Rasterer.getImgULLon(-122.24053, 7), 0.05);
//        assertEquals(30.0, Rasterer.getImgULLat(37.87548, 7), 0.05);
